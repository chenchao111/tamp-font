/**
 * umi.js文件 umi目录的主文件，是对umi目录下和其他目录下文件的引用
 * 主要功能是reander渲染整个react工程到root节点下，并把相关路由的children加载
 */
import './polyfills';
...
import findRoute, {
  getUrlQuery,
} from '/Users/chenchao/Documents/umi/umi-dva-antd-mobile/node_modules/umi-build-dev/lib/findRoute.js';
