...
class Home extends PureComponent {
  ...
  componentWillMount() {
    console.log('home 页面将要被渲染');
  }
  render() {
    console.log('home 页面被render');
      ...
      <div className="homePage">
        ...
        <div className="stepBlock hotMobileBlock">
          ...
          <Flex className="hotMobile_block">
            <Flex.Item>
              <div className="hotMobile" onClick={() => router.push('/detail?brand=52')}>
                <div className="hotMobile_icon"></div>苹果
              </div>
            </Flex.Item>
            <Flex.Item>
              <div className="hotMobile" onClick={() => router.push('/detail?brand=4')}>
                <div className="hotMobile_icon oppo"></div>OPPO
              </div>
            </Flex.Item>
            <Flex.Item>
              <div className="hotMobile" onClick={() => router.push('/detail?brand=16')}>
                <div className="hotMobile_icon vivo"></div>VIVO
              </div>
            </Flex.Item>
            <Flex.Item>
              <div className="hotMobile" onClick={() => router.push('/detail?brand=9')}>
        ...
        <div className="itemList itemList2">
          <div className="itemListtitle">
            热门回收
            <div className="gotoMore" onClick={() => router.push('/detail')}>
              更多
