    ...
    return (
      <div className='homePage'>
        <div className='homePage_search'>
          ...
          <div className='homePage_search_ico' onClick={() => router.push('/detail')}>
        ...
        <div className='stepBlock'>
          ...
          <img className='stepBlockimg' onClick={() => router.push('/detail')} src={require('../../assets/recycleH5_01.png')} alt="" />
        </div>
        <div className='stepBlock hotMobileBlock'>
          <div className='stepBlocktitle'>热门机型</div>
          <Flex className='hotMobile_block'>
            <Flex.Item><div className='hotMobile' onClick={() => router.push('/detail?brand=52')}><div  className='hotMobile_icon'></div>苹果</div></Flex.Item>
            <Flex.Item><div className='hotMobile' onClick={() => router.push('/detail?brand=4')}><div  className='hotMobile_icon oppo'></div>OPPO</div></Flex.Item>
            <Flex.Item><div className='hotMobile' onClick={() => router.push('/detail?brand=16')}><div  className='hotMobile_icon vivo'></div>VIVO</div></Flex.Item>
            <Flex.Item><div className='hotMobile' onClick={() => router.push('/detail?brand=9')}><div  className='hotMobile_icon huawei'></div>华为</div></Flex.Item>
          </Flex>
        </div>
        <div className='itemList itemList2'>
          <div className='itemListtitle'>热门回收<div className='gotoMore' onClick={() => router.push('/detail')}>更多<img src="https://res.zudeapp.com/wximage/right_arrow.png" alt=""/></div></div>
