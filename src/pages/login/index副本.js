...
// @connect(({ login }) => ({ login }))
class LoginNew extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      phone: '', // 电话
    ...
    return (
      <div className="login-bg">
        ...
        <div className="form-wraper">
          ...
          <div className={classNames('input-wrap-flex', 'margin-top-20')}>
            <div className="left">
              ...
              <CSSTransition in={phoneCode.length > 0} timeout={400} classNames="input">
                <input
                  value={phoneCode}
                  onChange={e => {
            ...
            <div className="right">
              <span
                className={classNames('code-info', {
                  'gray-info': isWait,
                  'active-info': codeText === '重新获取',
                })}
        ...
        <div className="login-wrap">
          <div className="login" onClick={this.submit}>
            登录/注册
          </div>
        </div>
        <p
